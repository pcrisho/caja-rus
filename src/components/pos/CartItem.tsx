  ...
  return (
    <div className="flex items-center gap-3 bg-white rounded-xl p-3 border border-gray-200">
        ...
        {isKg ? (
          ...
          <>
            ...
            <button
              ...
              className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center active:scale-95 transition-transform disabled:opacity-40"
      ...
      <div className="text-right">
        <p className="text-base font-bold text-gray-900">S/ {lineTotal}</p>
        <button
          onClick={() => removeItem(product.id)}
          className="text-red-600 mt-1 active:scale-95 transition-transform"
