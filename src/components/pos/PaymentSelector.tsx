              ...
              <div key={m} className="flex items-center gap-3">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full border-2 border-gray-300 rounded-xl py-3 pl-9 pr-4 text-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-900 focus-visible:border-blue-900"
                  />
                </div>
              </div>
            );
