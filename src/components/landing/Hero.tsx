      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start gap-6 text-left">
            {/* Technical Pill Tag */}
            <div className="inline-flex items-center gap-2 bg-emerald-100 dark:bg-emerald-900/30 border-2 border-emerald-400 text-emerald-900 rounded-md px-3.5 py-1 text-[11px] font-bold tracking-widest uppercase">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full pt-1">
              <div className="flex items-center gap-2.5 text-xs font-bold text-gray-900 dark:text-zinc-50 uppercase tracking-wide bg-white dark:bg-zinc-950 border border-gray-300 dark:border-zinc-700 px-3 py-2 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto pt-3">
              <a
                href="/register"
                className="w-full sm:w-auto bg-emerald-700 text-white rounded-lg py-4 px-8 text-sm font-bold uppercase tracking-wider hover:bg-emerald-800 active:scale-95 transition-transform cursor-pointer text-center flex items-center justify-center gap-3 border-2 border-emerald-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 min-h-[56px]"
              >
                REGISTRARSE
              ...
              <a
                href="/login"
                className="w-full sm:w-auto bg-white dark:bg-zinc-950 border-2 border-gray-900 rounded-lg py-4 px-8 text-sm font-bold uppercase tracking-wider text-gray-900 dark:text-zinc-50 hover:bg-gray-900 hover:text-white active:scale-95 transition-transform cursor-pointer text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 min-h-[56px] flex items-center justify-center"
              >
                INGRESAR
              </a>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-center w-full">
            <div className="relative w-full max-w-[340px] sm:max-w-[360px] bg-gray-900 rounded-2xl p-3 border-4 border-gray-900 shadow-2xl">
              ...
              <div className="bg-white dark:bg-zinc-950 rounded-xl overflow-hidden pt-3 pb-3 px-3 flex flex-col gap-3 border border-gray-300 dark:border-zinc-700">
                {/* Header Terminal */}
                ...
                <div className="bg-white dark:bg-zinc-950 border-2 border-gray-300 dark:border-zinc-700 rounded-lg p-3 flex flex-col gap-2">
                  <div className="flex items-center justify-between text-[11px] font-bold uppercase tracking-wider">
                    ...
                    <span className="text-emerald-800 font-mono bg-emerald-100 dark:bg-emerald-900/30 border border-emerald-300 px-1.5 py-0.5 rounded">
                      CAT 1 (S/ 5,000)
                    </span>
                  </div>

                  <div className="bg-gray-200 rounded h-3 overflow-hidden border border-gray-300 dark:border-zinc-700">
                    <div
                ...
                <div className="bg-white dark:bg-zinc-950 border-2 border-gray-300 dark:border-zinc-700 rounded-lg p-3 flex flex-col gap-2">
                  <div className="flex items-center justify-between border-b-2 border-gray-200 dark:border-zinc-800 pb-1.5">
                    ...
                    <span className="text-[10px] font-mono font-bold text-gray-600 dark:text-zinc-400 bg-gray-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded">
                      3 ITEMS
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-1 pt-1">
                    ...
                    <span className="text-center bg-white dark:bg-zinc-950 border border-gray-400 text-gray-900 dark:text-zinc-50 rounded py-1 text-[10px] font-bold uppercase tracking-wider">
                      EFECTIVO
                    </span>
                    <span className="text-center bg-white dark:bg-zinc-950 border border-gray-400 text-gray-900 dark:text-zinc-50 rounded py-1 text-[10px] font-bold uppercase tracking-wider">
                      TARJETA
                  ...
                  <div className="pt-1 border-t-2 border-gray-200 dark:border-zinc-800">
                    <div className="flex justify-between items-baseline mb-1">
                      ...
                      <span className="text-xl font-black text-gray-900 dark:text-zinc-50 font-mono">S/ 23.30</span>
                    </div>
