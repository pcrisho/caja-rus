    ...
    <section id="beneficios" className="py-16 sm:py-24 bg-gray-100 dark:bg-zinc-800 border-b-2 border-gray-300 dark:border-zinc-700">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Dueño / Administrador */}
          <div className="bg-white dark:bg-zinc-950  p-6 sm:p-8 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-gray-200 dark:border-zinc-800">
                <div className="w-11 h-11  bg-gray-900 text-white flex items-center justify-center">
              ...
              <ul className="flex flex-col gap-3.5 text-sm text-gray-800 dark:text-zinc-100 font-medium">
                <li className="flex items-start gap-3 bg-gray-50 dark:bg-zinc-900 p-3 ">
                  <span className="w-5 h-5  bg-emerald-700 text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                    ✓
                  </span>
                  <span>
          ...
          <div className="bg-white dark:bg-zinc-950  p-6 sm:p-8 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-gray-200 dark:border-zinc-800">
                <div className="w-11 h-11  bg-emerald-700 text-white flex items-center justify-center">
                  <Zap className="w-6 h-6 stroke-[2.5]" />
                </div>
                <div>
                  <span className="text-[10px] font-bold tracking-widest uppercase text-emerald-500">ROL 02</span>
              ...
              <ul className="flex flex-col gap-3.5 text-sm text-gray-800 dark:text-zinc-100 font-medium">
                <li className="flex items-start gap-3 bg-gray-50 dark:bg-zinc-900 p-3 ">
                  <span className="w-5 h-5  bg-gray-900 text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                    ✓
                  </span>
                  <span>
