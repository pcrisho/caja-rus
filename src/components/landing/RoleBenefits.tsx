...
export function RoleBenefits() {
  return (
    <section id="beneficios" className="py-16 sm:py-24 bg-gray-100 border-b-2 border-gray-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-1.5 bg-gray-200 border border-gray-400 text-gray-900 rounded-md px-3.5 py-1 text-[11px] font-bold tracking-widest uppercase mb-3">
            <HeartHandshake className="w-4 h-4 text-gray-900 stroke-[2.5]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Dueño / Administrador */}
          <div className="bg-white rounded-xl p-6 sm:p-8 border-2 border-gray-300 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-gray-200">
                ...
                <div>
                  <span className="text-[10px] font-bold tracking-widest uppercase text-gray-500">ROL 01</span>
                  <h3 className="text-xl font-black text-gray-900 uppercase">ADMINISTRADOR / DUEÑO</h3>
                </div>
              </div>

              <ul className="flex flex-col gap-3.5 text-sm text-gray-800 font-medium">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-gray-200">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-black text-gray-900 uppercase">OPERADOR / CAJERO</h3>
                </div>
              </div>
