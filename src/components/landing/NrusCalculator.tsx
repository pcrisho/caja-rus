  ...
  return (
    <section id="calculadora-nrus" className="py-16 sm:py-24 bg-white dark:bg-zinc-950 border-b-2 border-gray-300 dark:border-zinc-700">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white dark:bg-zinc-950 border-2 border-gray-900 rounded-xl p-5 sm:p-8">
          <div className="flex flex-col gap-6">
            {/* Sales Input Slider & Quick Touch Buttons */}
            <div className="bg-gray-50 dark:bg-zinc-900 border-2 border-gray-200 dark:border-zinc-800 rounded-lg p-4 sm:p-5">
              ...
              <div className="flex items-center gap-3 my-2">
                <button
                  ...
                  className="w-11 h-11 rounded-lg bg-white dark:bg-zinc-950 border-2 border-gray-400 text-gray-900 dark:text-zinc-50 font-bold flex items-center justify-center active:bg-gray-200 active:scale-95 transition-all shrink-0 touch-manipulation cursor-pointer"
                >
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-gray-200 dark:border-zinc-800 mt-3">
                    ...
                    <button
                      ...
                      className={`px-2.5 py-1 rounded text-[11px] font-mono font-bold border transition-colors touch-manipulation ${
                        monthlySales === preset
                          ...
                          : "bg-white dark:bg-zinc-950 text-gray-800 dark:text-zinc-100 border-gray-300 dark:border-zinc-700 hover:bg-gray-100 dark:hover:bg-zinc-800"
                      }`}
                    >
                      {formatMoney(preset)}
                    </button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Metric Card 1 */}
              <div className="bg-white dark:bg-zinc-950 border-2 border-gray-300 dark:border-zinc-700 rounded-lg p-4 sm:p-5 flex flex-col justify-between">
                ...
                <span className="text-[11px] font-bold text-gray-600 dark:text-zinc-400 mt-2 border-t border-gray-200 dark:border-zinc-800 pt-2">
            ...
            <div className="bg-white dark:bg-zinc-950 border-2 border-gray-300 dark:border-zinc-700 rounded-lg p-4 sm:p-5 flex flex-col gap-3">
              <div className="flex justify-between items-center text-xs font-black uppercase tracking-wider">
                ...
                <span
                  className={`px-2.5 py-0.5 rounded text-[11px] font-mono font-bold ${
                    statusColor === "emerald"
                      ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-900 border border-emerald-400"
                      : statusColor === "amber"
                      ? "bg-amber-100 dark:bg-amber-900/30 text-amber-900 border border-amber-400"
                      : "bg-red-100 dark:bg-red-900/30 text-red-900 border border-red-400"
                  }`}
                >
              ...
              {/* Bar */}
              <div className="w-full bg-gray-200 rounded h-4 overflow-hidden border border-gray-300 dark:border-zinc-700">
                <div
              ...
              <div
                className={`p-3.5 rounded-lg text-xs leading-relaxed flex items-start gap-2.5 font-medium ${
                  statusColor === "emerald"
                    ? "bg-emerald-50 dark:bg-emerald-900/20 text-emerald-950 border border-emerald-300"
                    : statusColor === "amber"
            ...
            <div className="flex items-center gap-2 text-xs text-gray-800 dark:text-zinc-100 bg-gray-100 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-lg p-3 font-medium">
