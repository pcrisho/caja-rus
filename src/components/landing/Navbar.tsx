      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-xs font-bold uppercase tracking-wider text-gray-700 dark:text-zinc-300">
          <a
            ...
            className="hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 rounded-md px-1 py-0.5"
          >
            Módulos POS
          </a>
          <a
            href="#calculadora-nrus"
            className="hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors flex items-center gap-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 rounded-md px-1 py-0.5 text-emerald-700 dark:text-emerald-400"
          >
        ...
        <div className="hidden sm:flex items-center gap-3">
          {isLoggedIn ? (
            ...
            <>
              <Link
                href="/login"
                className="inline-flex items-center justify-center text-gray-900 dark:text-zinc-50 border-2 border-gray-900 rounded-lg px-4 py-2 text-xs font-bold uppercase tracking-wider hover:bg-gray-900 hover:text-white active:scale-95 transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-gray-900"
              >
                Ingresar
              </Link>
              <Link
        ...
        <button
          ...
          className="sm:hidden p-2 text-gray-900 dark:text-zinc-50 hover:text-emerald-700 dark:hover:text-emerald-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 rounded-lg border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 cursor-pointer touch-manipulation active:scale-95"
        >
        ...
        <div className="sm:hidden bg-white dark:bg-zinc-950 border-b-2 border-gray-300 dark:border-zinc-700 px-4 pt-3 pb-6 flex flex-col gap-4 shadow-lg">
          <nav className="flex flex-col gap-2 text-xs font-bold uppercase tracking-wider text-gray-800 dark:text-zinc-100">
            <a
              ...
              className="px-3 py-2.5 rounded-lg border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900 hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors"
            >
              Módulos POS
            </a>
            <a
              href="#calculadora-nrus"
              onClick={() => setMobileMenuOpen(false)}
              className="px-3 py-2.5 rounded-lg border border-emerald-300 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-800 flex items-center justify-between"
            >
          ...
          <div className="pt-2 flex flex-col gap-3 border-t border-gray-200 dark:border-zinc-800">
            {isLoggedIn ? (
              <Link
                href="/tenants"
                onClick={() => setMobileMenuOpen(false)}
              ...
              <>
                ...
                <Link
                  href="/login"
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-full bg-white dark:bg-zinc-950 text-gray-900 dark:text-zinc-50 border-2 border-gray-900 text-center rounded-lg py-3 text-xs font-bold uppercase tracking-wider hover:bg-gray-900 hover:text-white active:scale-95 transition-transform"
                >
