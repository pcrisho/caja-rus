  ...
  return (
    <div className="min-h-dvh bg-gray-100 flex flex-col justify-between p-4 sm:p-6 font-sans text-gray-900">
      ...
      <header className="max-w-md mx-auto w-full flex items-center justify-between py-4">
        ...
        <Link
          href="/login"
          className="text-xs font-bold uppercase tracking-wider text-gray-900 border-2 border-gray-900 rounded-lg px-3 py-2 hover:bg-gray-900 hover:text-white transition-colors"
        >
          Ingresar
        </Link>
      </header>
      ...
      <main className="max-w-md mx-auto w-full my-auto">
        <div className="bg-white border-2 border-gray-900 rounded-xl p-5 sm:p-7 shadow-md">
          {/* Header Progress Bar for steps 1 and 2 */}
          {currentStep > 0 && currentStep < 3 && (
            <div className="mb-6 border-b-2 border-gray-200 pb-4">
              <div className="flex items-center justify-between text-xs font-black uppercase tracking-widest text-gray-700 mb-2">
                <span>REGISTRO DE BODEGA</span>
                <span className="font-mono bg-gray-100 border border-gray-300 px-2 py-0.5 rounded text-gray-900">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="border-2 border-emerald-300 rounded-xl p-4 bg-emerald-50 flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-black uppercase tracking-widest bg-emerald-700 text-white rounded px-2 py-0.5 font-mono">
                    OPCIÓN 1
                  </span>
                ...
                <button
                  ...
                  className="w-full bg-white border-2 border-gray-300 rounded-lg py-3.5 px-4 text-xs font-bold text-gray-900 flex items-center justify-center gap-3 hover:bg-gray-100 active:scale-95 transition-transform cursor-pointer shadow-xs min-h-[52px]"
                >
              ...
              <div className="border-2 border-gray-300 rounded-xl p-4 bg-gray-50 flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-black uppercase tracking-widest bg-gray-900 text-white rounded px-2 py-0.5 font-mono">
                    OPCIÓN 2
                  </span>
                ...
                <button
                  ...
                  className="w-full bg-emerald-700 text-white rounded-lg py-4 px-4 text-xs font-black uppercase tracking-wider hover:bg-emerald-800 active:scale-95 transition-transform cursor-pointer shadow-xs border-2 border-emerald-900 min-h-[56px] flex items-center justify-center gap-2"
                >
              ...
              <div className="pt-2 text-center">
                <p className="text-xs text-gray-600 font-medium">¿Ya tienes cuenta?</p>
                <Link
                  href="/login"
          ...
          {currentStep > 0 && currentStep < 3 && (
            <form action={formAction} className="flex flex-col gap-5">
              {registerState.message && !registerState.success && (
                <div
                  role="alert"
                  className="bg-red-100 border-2 border-red-400 text-red-950 p-4 rounded-lg text-xs font-medium flex items-start gap-2.5"
                >
              ...
              {currentStep === 1 && (
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-2 text-xs font-black uppercase tracking-wider text-gray-900 pb-1 border-b border-gray-200">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full border-2 border-gray-300 rounded-lg py-3.5 px-4 text-sm font-medium text-gray-900 bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 uppercase placeholder:text-gray-400"
                    />
                    {stepErrors.name && (
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full border-2 border-gray-300 rounded-lg py-3.5 px-4 text-sm font-mono font-medium text-gray-900 bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900"
                    />
                    {stepErrors.phone && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor="password" className="text-xs font-black tracking-widest uppercase text-gray-800">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor="confirmPassword" className="text-xs font-black tracking-widest uppercase text-gray-800">
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    <button
                      type="button"
                      onClick={prevStep}
                      className="w-1/3 bg-white border-2 border-gray-900 text-gray-900 rounded-lg py-4 text-xs font-bold uppercase tracking-wider hover:bg-gray-100 active:scale-95 transition-transform min-h-[56px] flex items-center justify-center gap-1 cursor-pointer"
                    >
                    ...
                    <button
                      type="button"
                      onClick={nextStep}
                      className="w-2/3 bg-emerald-700 text-white rounded-lg py-4 px-4 text-xs font-black uppercase tracking-wider hover:bg-emerald-800 active:scale-95 transition-transform cursor-pointer shadow-xs border-2 border-emerald-900 min-h-[56px] flex items-center justify-center gap-2"
                    >
              ...
              {currentStep === 2 && (
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="rucOrDni" className="text-xs font-black tracking-widest uppercase text-gray-800">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="sunatRegime" className="text-xs font-black tracking-widest uppercase text-gray-800">
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full border-2 border-gray-300 rounded-lg py-3.5 px-4 text-xs font-bold text-gray-900 bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 uppercase"
                    >
                  ...
                  {googleOnboardingError && (
                    <div
                      role="alert"
                      className="bg-red-100 border-2 border-red-400 text-red-950 p-3 rounded-lg text-xs font-bold"
                    >
                      {googleOnboardingError}
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    {isGoogleSetup ? (
                      <button
                        ...
                        className="w-full bg-emerald-700 text-white rounded-lg py-4 px-4 text-xs font-black uppercase tracking-wider hover:bg-emerald-800 active:scale-95 transition-transform cursor-pointer shadow-xs border-2 border-emerald-900 min-h-[56px] flex items-center justify-center gap-2 disabled:opacity-50"
                      >
                      ...
                      <button
                        type="submit"
                        disabled={isPending}
                        className="w-2/3 bg-emerald-700 text-white rounded-lg py-4 px-4 text-xs font-black uppercase tracking-wider hover:bg-emerald-800 active:scale-95 transition-transform cursor-pointer shadow-xs border-2 border-emerald-900 min-h-[56px] flex items-center justify-center gap-2 disabled:opacity-50"
                      >
                        {isPending ? (
                          <>
                            <Loader2 className="w-4 h-4 animate-spin stroke-[2.5]" />
          ...
          {currentStep === 3 && (
            <div className="flex flex-col gap-5">
              <div className="bg-emerald-50 border-2 border-emerald-400 rounded-xl p-5 text-center flex flex-col items-center gap-3">
                <div className="w-12 h-12 rounded-lg bg-emerald-700 text-white flex items-center justify-center font-black text-xl border border-emerald-900">
                  ✓
                </div>
                <h2 className="text-xl font-black text-gray-900 uppercase">¡BODEGA REGISTRADA CON ÉXITO!</h2>
              ...
              <div className="border-2 border-gray-900 rounded-xl p-4 bg-gray-50 flex flex-col gap-4">
                ...
                <form action={inviteFormAction} className="flex flex-col gap-3">
                  <div className="flex flex-col gap-1">
                    <label htmlFor="inviteName" className="text-[11px] font-black uppercase text-gray-800">
                    ...
                    <input
                      ...
                      className="w-full border-2 border-gray-300 rounded-lg py-2.5 px-3 text-xs font-medium text-gray-900 bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 uppercase"
                    />
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1">
                      <label htmlFor="inviteContact" className="text-[11px] font-black uppercase text-gray-800">
                        Celular o Correo
                      </label>
                      <input
                        id="inviteContact"
                        ...
                        className="w-full border-2 border-gray-300 rounded-lg py-2.5 px-3 text-xs font-medium text-gray-900 bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900"
                      />
                    </div>

                    <div className="flex flex-col gap-1">
                      <label htmlFor="role" className="text-[11px] font-black uppercase text-gray-800">
                        Rol asignado
                      </label>
                      <select
                        id="role"
                        ...
                        className="w-full border-2 border-gray-300 rounded-lg py-2.5 px-3 text-xs font-bold text-gray-900 bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 uppercase"
                      >
                  ...
                  <button
                    ...
                    className="w-full bg-gray-900 text-white rounded-lg py-3 px-4 text-xs font-bold uppercase tracking-wider hover:bg-black active:scale-95 transition-transform cursor-pointer flex items-center justify-center gap-2 mt-1"
                  >
                    {isInvitePending ? (
                ...
                <div className="mt-2 pt-3 border-t border-gray-300">
                  ...
                  <div className="flex items-center justify-between bg-white border border-gray-300 rounded-lg p-2 text-xs font-medium">
                    <div className="flex items-center gap-2">
                      <div className="w-7 h-7 rounded bg-emerald-700 text-white font-bold flex items-center justify-center text-[10px]">
                        TÚ
                      </div>
                      <div>
                        <p className="font-bold text-gray-900 uppercase">{formData.name || "Administrador"}</p>
              ...
              <Link
                href="/login"
                className="w-full bg-emerald-700 text-white rounded-lg py-4 px-6 text-xs font-black uppercase tracking-wider hover:bg-emerald-800 active:scale-95 transition-transform text-center shadow-xs border-2 border-emerald-900 min-h-[56px] flex items-center justify-center gap-2"
              >
