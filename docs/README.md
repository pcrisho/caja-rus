...
- [x] Modelo de datos (Prisma) con 14 modelos y 6 enums
- [x] Arquitectura del sistema con Auth.js v5 + Google OAuth
- [x] Inicialización del proyecto Next.js 15 + TypeScript + Tailwind v4
- [x] Configuración de Prisma y singleton
- [x] Configuración PWA (manifest + service worker)
- [x] Variables de entorno documentadas (`.env.example`)
- [x] Autenticación con Google OAuth (Auth.js v5 + middleware + JWT strategy)
...
- [ ] Sincronización offline (cola + idempotency keys)
